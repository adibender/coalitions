...
survey <- scrape_wahlrecht(address = "https://www.wahlrecht.de/umfragen/insa.htm" ) %>%
...
survey2 <- scrape_wahlrecht(address = "https://www.wahlrecht.de/umfragen/allensbach.htm") %>%
