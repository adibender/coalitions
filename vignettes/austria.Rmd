...
applied to other elections, using the Austrian "Nationalratswahlen" aus
an example.
...
To obtain a *pooled*  survey (wheited average over last 14 days, that takes
...
be a *pooled* survey. Given the survey, the workflw is equivalent to the one
described in the [workflow vignette](https://adibender.github.io/coalitions/articles/workflow.html). However,
it is necessary, to take the method for seat distribution, as well as the
threshold and number of seats of the specific parliament of interest into
account.
